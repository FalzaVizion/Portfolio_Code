  ...
  return (
    <section className='max-container'>
      ...
      <div className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>
          Game Developer turning ideas into playable worlds. One blueprint at a time.
          <br/> Technical Artist focused in immersive and real-time experiences with Unreal Engine.
        </p>
      </div>
            ...
            <div className='block-container w-20 h-20' key={skill.name}>
              ...
              <div className='btn-front rounded-xl flex justify-center items-center'>
                <img
                  src={skill.imageUrl}
                  alt={skill.name}
                  className=/*'w-1/2 h-1/2 object-contain'*/ 'w-1/2 h-1/2 object-contain'
                />
              </div>
            </div>
          ))}
